<template lang="pug">
  .page_main
    main.page_content.content-wrap(
      :class="{'error-combination': false}"
    )
      header.reg_header
        h1.h2 Login
        p To use JAM example you have to sign in
      .reg_body
        ...
        form(name="loginForm")
          ...
          .input-holder
            ...
            a.input_link(href="#") Forgot password?
        ...
        p By signing in, I acknowledge and agree to
          br
          span House&ensp;
          router-link(to="/some-link") Terms and Conditions
          span &ensp;and&ensp;
          router-link(to="/some-link") Privacy Policy.

      footer.reg_footer
        h4.h4 or use social account for authentication
        .d-flex
          a.btn.btn--social-login(href="#")
            i.fa.fa-facebook
...
<style lang="scss" scoped>
  ...
  .page_content {
    ...
    box-shadow: 0 0 0 10px $white, 0 12px 15px -2px rgba(#000, .75);
  }
  /*----- header -----*/
  .reg_header {
    padding: 42px 15px 0;
  ...
  .popup-login_card-info {
    ...
    hr {
      border: none;
      border-bottom: 1px solid $col-placeholder;
      position: absolute;
      left: 0;
      right: 0;
      top: 50%;
